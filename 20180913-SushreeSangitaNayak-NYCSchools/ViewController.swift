...
class ViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
         ...
         var schoolDetailsFound : Bool = false
            for schooldetail in schoolDetails{
                if(schooldetail.school_name.uppercased() == schoolNameClicked.uppercased()){
                    ...
                    print(selectedSchoolDetail)
                    
                    selectedSchool=schoolNames[indexPath.row]
                     print(selectedSchool)
                     print(selectedSchoolDetail.school_name)
        ...
        if(!schoolDetailsFound){
            let alert = UIAlertController(title: "School Details", message: "SAT Details Not Available for this  School", preferredStyle: UIAlertControllerStyle.alert)
